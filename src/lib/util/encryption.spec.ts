import { chacha20_poly1305_decryptAndVerify, chacha20_poly1305_encryptAndSeal } from "./encryption";
...
/*
 * This test is to there to test the underlying node crypto / openssl implementation (this is tested well enough)
